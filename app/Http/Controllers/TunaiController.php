...
class TunaiController extends Controller
{
    ...
    {
        $viewtunais = DB::table('viewtunai')->select('*')->get();
        return view('tunai.tunai', compact('viewtunais'));
    }
    ...
    {
        $viewtunais = DB::table('viewtunai')->where('id', $id)->get();
        $penduduks = Penduduk::orderBy('nik_kk', 'ASC')->get();
        return view('tunai.edit', compact('viewtunais', 'penduduks'));
    }
