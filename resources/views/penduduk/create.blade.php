                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <select name="penghasilan" class="form-control">
                                <option value="Pilih Jumlah Penghasilan">Pilih Jumlah Penghasilan</option>
                                <option value="100.000 - 500.000">100.000 - 500.000</option>
                                <option value="500.000 - 1.000.000">500.000 - 1.000.000</option>
                                <option value="1.000.000 - 2.000.000">1.000.000 - 2.000.000</option>
                                <option value="Diatas 2.000.000">Diatas 2.000.000</option>
                            </select>
                        </div>

                        <label class="form-label col-sm-2">Alamat</label>
                        <div class="col-sm-4">
                            <input type="text" name="alamat" placeholder="Alamat Tempat Tinggal" class="form-control" value="{{old('alamat') }}" required>
                        </div>
                    </div>
